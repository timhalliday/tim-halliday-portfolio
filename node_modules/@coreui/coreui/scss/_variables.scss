...
$variable-prefix:             cui- !default; // Deprecated in v4.3.0 for the shorter `$prefix`
...
// fusv-disable
$text-muted:                  var(--#{$prefix}secondary-color) !default; // Deprecated in 4.3.0
// fusv-enable
...
// fusv-disable
$tooltip-arrow-color:               null !default; // Deprecated in Bootstrap 4.2.0 for CSS variables
// fusv-enable
...
$subheader-border-width:         var(--#{$prefix}border-width) !default;
...
$carousel-indicator-active-bg:        #f6838b;
