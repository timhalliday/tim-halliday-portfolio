...
export default function Data() {
  ...
  function toggleHandAnimate(event){
    if (event.type === 'mouseenter') {
      setHandAnimate(true)
    } else if (event.type === 'mouseleave') {
      setHandAnimate(false)
    }
  }
    ...
    <div className="home__data">
      <h1 className="home__title">
        ...
        <svg
          ...
          className={handAnimate ? "home__hand wave" : "home__hand"}
          onMouseEnter={toggleHandAnimate}
          onMouseLeave={toggleHandAnimate}
        >
          <path
